...
import 'package:flutter_katalk/components/bottom_icon_button.dart';
import 'package:flutter_katalk/components/round_icon_button.dart';
import 'package:flutter_katalk/models/user.dart';
    ...
    return Container(
      decoration: BoxDecoration(
        image: DecorationImage(
          ...
          fit: BoxFit.fitHeight, //이미지를 높이에 맞춰서 축소, 확대
        ),
      ),
      child: Scaffold(
